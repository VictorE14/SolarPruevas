...
async function login(email, password) {
    try {
        ...
        await db.registrarLog(usuario.id, usuario.nombre, 'Inicio de sesión', 'Desde el sistema de monitoreo');
...
// ============================================================
//  CARGAR INVERSORES (filtrados por técnico)
// ============================================================
...
// ============================================================
//  CLIMA Y RADIACIÓN (funciones existentes)
// ============================================================
...
document.getElementById('loginForm')?.addEventListener('submit', async function(e) {
    ...
    if (result.success) {
        ...
        document.getElementById('userRole').textContent = result.usuario.rol.charAt(0).toUpperCase() + result.usuario.rol.slice(1);
